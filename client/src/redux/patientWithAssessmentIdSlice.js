...
export const { addItem, removeItem, resetItems } = patientWithAssessmentIdSlice.actions;
export const currentPatientsWithAssessment = (state) => state.getAssessmentId.myArray;
